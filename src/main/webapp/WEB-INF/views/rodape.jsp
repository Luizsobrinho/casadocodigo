...
<footer id="layout-footer">
		<div class="clearfix container">
			...
			<div id="collections-footer">
				<!-- cdc-footer -->
				<p class="footer-title">Coleçõess de Programação</p>
			...
			<div id="social-footer">
				<!-- books-footer -->
				<p class="footer-title">Links da Casa do Cádigo</p>
				<ul class="footer-text-links">
					...
					<li><a href="http://www.casadocodigo.com.br/pages/politica-de-privacidade" rel="nofollow">Politíca de Privacidade</a></li>
				</ul>
			...
			<div id="newsletter-footer">
				<!-- social-footer -->
				<p class="footer-title">Receba as Novidades e Lançaamentos</p>
